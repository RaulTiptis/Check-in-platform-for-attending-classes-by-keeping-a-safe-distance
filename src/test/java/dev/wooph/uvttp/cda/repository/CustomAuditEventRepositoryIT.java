...
import dev.wooph.uvttp.cda.config.audit.AuditEventConverter;
import dev.wooph.uvttp.cda.domain.PersistentAuditEvent;
...
import static dev.wooph.uvttp.cda.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
