...
import dev.wooph.uvttp.cda.ClassroomDistancingApp;
import dev.wooph.uvttp.cda.config.Constants;
import dev.wooph.uvttp.cda.domain.User;
import dev.wooph.uvttp.cda.repository.AuthorityRepository;
import dev.wooph.uvttp.cda.repository.UserRepository;
import dev.wooph.uvttp.cda.security.AuthoritiesConstants;
import dev.wooph.uvttp.cda.service.UserService;
import dev.wooph.uvttp.cda.service.dto.PasswordChangeDTO;
import dev.wooph.uvttp.cda.service.dto.UserDTO;
import dev.wooph.uvttp.cda.web.rest.vm.KeyAndPasswordVM;
import dev.wooph.uvttp.cda.web.rest.vm.ManagedUserVM;
...
import static dev.wooph.uvttp.cda.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = ClassroomDistancingApp.class)
